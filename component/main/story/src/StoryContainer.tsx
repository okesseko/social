    ...
    >
      ...
      >
        <View style={styles.container}>
          ...
          <UserView
            name={dataStories.username as string}
            profile={dataStories.profile as string}
            datePublication={stories[currentIndex].created as string}
        ...
        >
          ...
          <WebView source={{ uri: stories[currentIndex].url_readmore } as any} />
        </Modal>
      </TouchableOpacity>
    </GestureRecognizer>
  );
